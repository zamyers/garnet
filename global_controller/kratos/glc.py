...
class GlobalController(Generator):
    ...
    def inst_glc_core(self):
        '''
        This function instantiates global controller core
        '''
        self.add_child("glc_core",
                       GlcCore(self.p_glc_hs_awidth, self.p_glc_hs_dwidth),
                       comment="glc core")
        self.wire(self.clk, self["glc_core"].clk)

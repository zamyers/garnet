...
class GlcAxilController(Generator):
    ...
    def add_cfg_ports(self):
        ...
        self._cfg_wr_resp = self.input("_cfg_wr_resp", 1)
        self._cfg_rd_req = self.output("_cfg_rd_req", 1)
        self._cfg_rd_addr = self.output("_cfg_rd_addr", self.p_axil_awidth)
        self._cfg_rd_data = self.input("_cfg_rd_data", self.p_axil_dwidth)
        self._cfg_rd_resp = self.input("_cfg_rd_resp", 1)

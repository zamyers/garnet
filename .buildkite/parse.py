...
def parse_memcore(filename):
    ...
    print("@file TOTAL,%f" % results["Tile_MemCore"])
    print("@file DOUBLE BUFFER control,%f" % results["doublebuffer_control"])
    print("@file FIFO control,%f" % results["fifo_control"])
    print("@file LINEBUFFER control,%f" % results["linebuffer_control"])
    print("@file SRAM control,%f" % results["sram_control"])
    print("@file MEMORY,%f" % results["mem_inst"])
    print("@file INTERCONNECT,%f" % results["interconnect"])
    print("@file OTHER,%f" % other)
    print("@file OTHER2,%f" % (results["fifo_control"] + results["linebuffer_control"] + results["sram_control"] + other))

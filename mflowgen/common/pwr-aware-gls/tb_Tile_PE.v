module tb_Tile_PECore();
  ...
  initial begin
      ...
      #1 $display("All global signals are = clk_out: %h clk_pass_through: %h reset: %h config_out_config_addr: %h config_out_config_data: %h config_out_read: %h config_out_write: %h read_config_data: %h stall_out: %h", clk_out, clk_pass_through,  reset_out, config_out_config_addr, config_out_config_data, config_out_read, config_out_write, read_config_data, stall_out);   
      #1 $display("VDD = %h", VDD);
      #1 $display("VSS = %h", VSS);
      #1 $display("VDD_SW = %h", dut.VDD_SW);
      #1 $display("\n===================================");
...
/*
      ...
      #1 $display("VSS = %h", VSS);
      #1 $display("VDD_SW = %h", dut.VDD_SW);
      #1 config_config_addr = 32'h00040000; //32'h00040000;
      #1 config_config_data = 32'd20;
      #1 config_write = 1;
      #1 $display("Sel = %d",dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.S);
      #1 $display("AOI-CONST MUX OUT = %h", dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.O);
      #1 $display("Inter AOI-CONST MUX OUT = %h", dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.u_mux_logic.O0);
      #1 $display("\n===================================");
      #1 $display("ASSERTION #6");
      #1 assert (dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.O == 0) $display ("ASSERTION 6 PASS: Constant mux output generated when sel==height");
         else $error("ASSERTION 6 FAIL: AOI-Const Mux output incorrect when sel==height");
      #1 $display("ASSERTION #7");
      #1 assert (dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.u_mux_logic.O0 == 0 && dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.u_mux_logic.O1 == 0 && dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.u_mux_logic.O2 == 0 && dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.u_mux_logic.O3 == 0 && dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.u_mux_logic.O4 == 0 && dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.u_mux_logic.O5 == 0 && dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.u_mux_logic.O6 == 0 && dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.u_mux_logic.O7 == 0 && dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.u_mux_logic.O8 == 0 && dut.CB_data0.CB_data0_mux_aoi_const_20_16_inst0.u_mux_logic.O9 == 0) $display ("ASSERTION 7 PASS: X Prop is terminated at 1st stage of MUX");
